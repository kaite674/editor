...
export const tools: ToolConfig[] = [
  ...
  { id: 'column', iconSrc: '/icons/column.png', label: '柱子' },
  { id: 'elevator', iconSrc: '/icons/elevator.svg', label: '电梯' },
  { id: 'roof', iconSrc: '/icons/roof.png', label: '山墙屋顶' },
  ...
  { id: 'fence', iconSrc: '/icons/fence.png', label: '围栏' },
  { id: 'zone', iconSrc: '/icons/zone.png', label: '区域' },
  { id: 'spawn', iconSrc: '/icons/site.png', label: '出生点' },
]
