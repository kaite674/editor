...
const SHORTCUT_CATEGORIES: ShortcutCategory[] = [
  ...
  },
  {
    title: '物品放置',
    shortcuts: [
      { keys: ['R'], action: '顺时针旋转物品，或切换所选门的打开/关闭' },
      { keys: ['T'], action: '逆时针旋转物品，或关闭所选门' },
      {
        keys: ['Shift'],
        action: '临时绕过放置验证约束',
        note: '放置时按住。',
